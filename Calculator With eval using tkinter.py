...
def btneq_clicked(*args):
    try:
        ...
        tkinter.messagebox.showerror("Value Error", "Check your values and syntax")
...
disp = Entry(root, font="Verdana 20", fg="black", bg="gray", bd=0, justify=RIGHT, insertbackground="gray", cursor="arrow")
